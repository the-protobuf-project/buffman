...
public final class MarkNotificationAsReadResponse extends Table {
  ...
  public static MarkNotificationAsReadResponse getRootAsMarkNotificationAsReadResponse(ByteBuffer _bb, MarkNotificationAsReadResponse obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createMarkNotificationAsReadResponse(FlatBufferBuilder builder,
      boolean success,
      int messageOffset) {
  ...
  public static int endMarkNotificationAsReadResponse(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public MarkNotificationAsReadResponse get(int j) { return get(new MarkNotificationAsReadResponse(), j); }
    public MarkNotificationAsReadResponse get(MarkNotificationAsReadResponse obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
