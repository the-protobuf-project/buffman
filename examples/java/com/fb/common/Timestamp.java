...
public final class Timestamp extends Table {
  ...
  public long seconds() { int o = __offset(4); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  ...
  public static void addSeconds(FlatBufferBuilder builder, long seconds) { builder.addLong(0, seconds, 0L); }
