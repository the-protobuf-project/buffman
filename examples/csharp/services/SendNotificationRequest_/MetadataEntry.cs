...
public struct MetadataEntry : IFlatbufferObject
{
  private Table __p;
  ...
  public static MetadataEntry GetRootAsMetadataEntry(ByteBuffer _bb, MetadataEntry obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public static Offset<services.SendNotificationRequest_.MetadataEntry> CreateMetadataEntry(FlatBufferBuilder builder,
  ...
  public static Offset<services.SendNotificationRequest_.MetadataEntry> EndMetadataEntry(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<services.SendNotificationRequest_.MetadataEntry>(o);
  }
}


static public class MetadataEntryVerify
{
