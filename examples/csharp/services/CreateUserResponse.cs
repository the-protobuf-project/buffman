...
public struct CreateUserResponse : IFlatbufferObject
{
  private Table __p;
  ...
  public static CreateUserResponse GetRootAsCreateUserResponse(ByteBuffer _bb, CreateUserResponse obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public static Offset<services.CreateUserResponse> CreateCreateUserResponse(FlatBufferBuilder builder,
  ...
  public static Offset<services.CreateUserResponse> EndCreateUserResponse(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<services.CreateUserResponse>(o);
  }
}


static public class CreateUserResponseVerify
{
