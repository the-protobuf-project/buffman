...
class SendNotificationRequest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SendNotificationRequest
     */
    public static function getRootAsSendNotificationRequest(ByteBuffer $bb)
    {
        $obj = new SendNotificationRequest();
     ...
     * @return void
     */
    public static function startSendNotificationRequest(FlatBufferBuilder $builder)
    {
     ...
     * @return SendNotificationRequest
     */
    public static function createSendNotificationRequest(FlatBufferBuilder $builder, $recipient_user_id, $type, $title, $content, $priority, $metadata)
    {
        $builder->startObject(6);
    ...
    {
        $builder->addOffsetX(0, $recipientUserId, 0);
    }
    ...
    {
        $builder->addOffsetX(5, $metadata, 0);
    }
     ...
     */
    public static function endSendNotificationRequest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
